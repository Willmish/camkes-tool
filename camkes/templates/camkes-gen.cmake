...
/*- for i in instances if not i.type.hardware -*/
    ...
    /*- if configuration[i.name].get('cantripos') -*/
        CAmkESGen("${generated_dir}/camkes.rs" component//*? i.name ?*/ component.common.rs)
    /*- else -*/
        CAmkESGen("${generated_dir}/camkes.c" component//*? i.name ?*/ component.common.c SOURCE C_STYLE)
    /*- endif -*/

    # Generate camkes C headers
    unset(CAMKES_INTERFACE_INCLUDES)
    /*- if configuration[i.name].get('cantripos') -*/
        # TODO(sleffler): don't think we need anything here
    /*- elif configuration[i.name].get('environment', 'c').lower() == 'c' -*/
...
#message("BASE TO CONNECTOR: " ${unique_name})
    ...
    /*- endif -*/
    /*- if configuration[i.name].get('cantripos') -*/
        CAmkESGen("${generated_dir}/camkes.fini.rs" component//*? i.name ?*/ component.fini.rs)
    /*- endif -*/

    /*- if not configuration[i.name].get('cantripos') -*/
...
message("COMPONENT " ${target} " LANGUAGE " ${link_language} " SOURCES " ${static_sources} ${gen_sources})
    ...
    /*- if configuration[i.name].get('cantripos') -*/
        # Do nothing -- don't need to link against camkes libs for cantrip
    /*- else -*/
